object frmCadastroMusica: TfrmCadastroMusica
  Left = 0
  Top = 0
  BiDiMode = bdLeftToRight
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Cadastro de M'#250'sicas'
  ClientHeight = 364
  ClientWidth = 341
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label6: TLabel
      ...
      Width = 104
      Height = 13
      Caption = 'DATA DA INSCRI'#199#195'O'
    end
    ...
    object dtpInscricao: TDateTimePicker
      Left = 16
      Top = 64
      Width = 137
      Height = 21
  ...
  object MainMenu1: TMainMenu
    Left = 112
    Top = 248
    object CadastrarParticipacao: TMenuItem
      Caption = 'Cadastrar Participa'#231#227'o'
      Visible = False
      OnClick = CadastrarParticipacao1Click
    end
  end
end
