object frmCadastroExecMusica: TfrmCadastroExecMusica
  ...
  object Panel1: TPanel
    ...
    object grdExec_Musica: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'DT_TOCOU'
          Title.Caption = 'DATA EXECU'#199#195'O'
          Width = 120
          Visible = True
        end
        item
    ...
    object cmbNomeMusica: TDBLookupComboBox
      Left = 16
      Top = 21
      Width = 308
      Height = 21
  ...
  object qryCmbMusica: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'Select idmusica, nome from musica')
    SQLConnection = ECAD.ConnectionECAD
    Left = 32
    Top = 184
    object qryCmbMusicaIDMUSICA: TFMTBCDField
      FieldName = 'IDMUSICA'
      Required = True
      Precision = 32
      Size = 0
    end
    object qryCmbMusicaNOME: TWideStringField
      FieldName = 'NOME'
      Size = 60
    end
  end
  object dstpCmbMusica: TDataSetProvider
    DataSet = qryCmbMusica
    Left = 32
    Top = 248
  end
  object cdsCmbMusica: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dstpCmbMusica'
    Left = 152
    Top = 184
  end
  object dtsCmbMusica: TDataSource
    DataSet = cdsCmbMusica
    Left = 144
    Top = 248
  end
end
