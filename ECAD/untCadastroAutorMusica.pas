...
begin
    ...
    try
        ...
        begin
          if (Application.MessageBox(pchar('Deseja Excluir o Música '+Autor+'?'),'Atenção!',MB_YESNO+MB_ICONWARNING) = ID_YES) then
           begin
            ...
            Application.MessageBox('Participação Excluída Com Sucesso!','Cadastro Autor',MB_OK);
        ...
        begin
          Application.MessageBox('Todos os Campos São Obrigatórios!','Atenção!',MB_OK);
          exit;
        end;
        ...
        begin
          Application.MessageBox('Total de Participação maior que 100%','Atenção"',MB_OK+MB_ICONEXCLAMATION);
        ...
        if (NomeBotao = 'Salvar') then
         begin
            ...
            Application.MessageBox('Participação Incluída Com Sucesso!','Atenção!',MB_OK);
    ...
    Except on E: Exception do
     begin
        Application.MessageBox(pchar('ERROR: '+E.Message),'Cadastro Participação', MB_OK);
        FreeAndNil(ECAD);
        CloseModal;
     end;
...
begin
  ...
  lblNomeMusica.Caption := 'MÚSICA: '+frmCadastroMusica.edtNomeMusica.Text;
